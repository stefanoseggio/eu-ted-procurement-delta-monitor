...
full commit history pushed — [github.com/stefanoseggio/eu-ted-procurement-delta-monitor](https://github.com/stefanoseggio/eu-ted-procurement-delta-monitor).
...
```bash
gh secret remove APIFY_TOKEN --repo stefanoseggio/eu-ted-procurement-delta-monitor
```
